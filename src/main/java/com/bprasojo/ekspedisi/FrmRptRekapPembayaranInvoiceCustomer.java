 ...
 *
 */
public class FrmRptRekapPembayaranInvoiceCustomer extends FrmDefault {
...
//        String reportPath = "src/main/java/com/bprasojo/ekspedisi/reports/DaftarPembayaranInvoice.jasper";
        InputStream jasperStream = getClass().getClassLoader().getResourceAsStream("reports/DaftarPembayaranInvoice.jasper");
